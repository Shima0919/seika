...
#計算BMI＝体重÷（身長×身長）
BMI=taijyu/(shintyou_m*shintyou_m85)
#条件
if BMI >= 40:
    print("BMIは",BMI,"で判定は肥満（4度）です")
    print("以上で終わります。")
elif BMI >= 35:
    print("BMIは",BMI,"で判定は肥満（3度）です")
    print("以上で終わります。")
elif BMI >=30:
    print("BMIは",BMI,"で判定は肥満（2度）です")
    print("以上で終わります。")
elif BMI >=25:
    print("BMIは",BMI,"で判定は肥満（1度）です")
    print("以上で終わります。")
elif BMI >=18:
    print("BMIは",BMI,"で判定は普通です")
    print("以上で終わります。")
else:
    print("BMIは",BMI,"で判定は痩せすぎです")
    print("以上で終わります。")
